...
public class BankAccount {
	...
	public BankAccount( String accountType, String accountHolderName, double accountBalance) {
		super();
	...
	public BankAccount(long accountId, String accountType, String accountHolderName) {
		super();
